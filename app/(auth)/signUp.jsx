      ...
      <View className='flex-1 flex-col h-screen'>
        <View className='flex-1 flex-col  justify-center'>
          ...
          <View className='flex-1 flex-col items-center'>
            ...
            <TextInput secureTextEntry={true} placeholder='Ingresa tu contraseña' className=' border-b-2 rounded-md w-3/4  text-black' />
          </View>
          <View className='flex-1 flex-col items-center'>
            <Text className='text-center text-xl'>Confirmar contraseña</Text>
            <TextInput secureTextEntry={true} placeholder='Confirma tu contraseña' className=' border-b-2 rounded-md w-3/4  text-black' />
          </View>
          <View className='flex-1 flex-col items-center'>
